...
async def FAQ(request:Request, object_id:PydanticObjectId):
    ...
    return templates.TemplateResponse(name="manag/user/manag_user_detail.html", context={'request':request,'users' : user_list})
...
async def academic(request:Request):
    return templates.TemplateResponse(name="manag/academic/manag_academic_main.html", context={'request':request})