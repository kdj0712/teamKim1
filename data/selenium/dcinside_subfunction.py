...
def selectCourts(browser):
    ...
    element_post = browser.find_elements(by=By.CSS_SELECTOR, value="#container > section.left_content > article:nth-child(3) > div.gall_listwrap.list > table > tbody > tr.ub-content.us-post")
    ...
    for element in element_post :
        ...
        dc_cate = element.find_element(by=By.CSS_SELECTOR, value="#container > section.left_content > article:nth-child(3) > div.gall_listwrap.list > table > tbody > tr > td.gall_num")
        ...
        if dc_cate.text !='공지' and dc_cate.text != '설문' :
            ...
            dc_content = browser.find_element(by=By.CSS_SELECTOR, value="#container > section > article:nth-child(3) > div.view_content_wrap > div > div.inner.clear > div.writing_view_box > div.write_div")
